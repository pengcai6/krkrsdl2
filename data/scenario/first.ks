...
[r]
@start_select
[link target="*return_to_game_selector"]ゲーム選択に戻る[endlink]
@end_select
[s]

*return_to_game_selector
@cm
ゲーム選択に戻ります...
@wait time=500
; 清除所有存储路径并重新加载游戏选择器
...
@jump storage="game_selector.ks" target="*game_selector_start"
...
[r]
@start_select
[link target="*return_to_game_selector"]Return to game selector[endlink]
@end_select
[s]
